...
#ifndef ANALISIS_DE_ALGORITMOS_SELECTIONSORT_H
#define ANALISIS_DE_ALGORITMOS_SELECTIONSORT_H
...
void pruebaSelectionSort(){
    ...
    Grapher(valoresPruebasX,valoresPruebasY,"selectionSort.txt","plot 'selectionSort.txt' using 1:2:(sprintf(\"(%d, %d)\", $1, $2)) with labels point pt 7 offset char 1,1 font ',14' notitle,\  'selectionSort.txt' w linespoint , '' with labels");
...
#endif //ANALISIS_DE_ALGORITMOS_SELECTIONSORT_H
